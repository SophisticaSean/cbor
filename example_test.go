...
import (
	...
	"github.com/SophisticaSean/cbor/v2" // remove "/v2" suffix if you're not using Go modules (see README.md)
)
...
func Example_senML() {
	...
	cborData, _ := hex.DecodeString(
		"",
	)
	var v []*SenMLRecord
	if err := cbor.Unmarshal(cborData, &v); err != nil {
		fmt.Println("error:", err)
...
func Example_webAuthn() {
	...
	cborData, _ := hex.DecodeString(
		"",
	)
